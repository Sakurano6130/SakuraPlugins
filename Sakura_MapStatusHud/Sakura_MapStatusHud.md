...
| ver   | 日付       | 説明                                                                                                                                                                                                                           |
| ----- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1.5.1 | 2025/02/14 | アクター間の余白に負の値を指定できるように。                                                                                                                                                                                   |
| 1.5.0 | 2024/11/22 | 職業名のメモ欄に<省略名:○○>と書くと、省略した職業名を表示できる機能を追加                                                                                                                                                      |
| 1.4.0 | 2024/11/19 | パーティーメンバーの数が `$gameParty.maxBattleMembers` を超える場合に控えメンバーが表示されないように修正                                                                                                                      |
...
- データベースの職業のメモ欄に<省略名:○○>と書くと、省略した職業名を表示できる `ver1.5`
